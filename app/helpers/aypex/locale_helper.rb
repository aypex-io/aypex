module Aypex
  module LocaleHelper
    ...
    def locale_presentation(locale)
      if I18n.exists?("aypex.i18n.this_file_language", locale: locale, fallback: false)
        [locale_full_name(locale), locale.to_s]
      elsif defined?(AypexI18n::Locale) && (language_name = AypexI18n::Locale.local_language_name(locale))
