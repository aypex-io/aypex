  ...
  module ReimbursementType::ReimbursementHelpers
    ...
    def create_refund(reimbursement, payment, amount, simulate)
      refund = reimbursement.refunds.build(
        payment: payment,
        amount: amount,
        reason: Aypex::RefundReason.return_processing_reason
      )
    ...
    def create_credit(reimbursement, unpaid_amount, simulate)
      category = Aypex::StoreCreditCategory.default_reimbursement_category(category_options(reimbursement))
      creditable = Aypex::StoreCredit.new(store_credit_params(category, reimbursement, unpaid_amount))
    ...
    def store_credit_params(category, reimbursement, unpaid_amount)
      {
        ...
        category: category,
        created_by: Aypex::StoreCredit.default_created_by,
