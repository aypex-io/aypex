module Aypex
  ...
  #    Aypex::ReturnAuthorization.reimbursement_tax_calculator = calculator_object
  ...
  class ReimbursementTaxCalculator
    class << self
      ...
      def set_tax!(return_item)
        calculated_refund = Aypex::ReturnItem.refund_amount_calculator.new.compute(return_item)
