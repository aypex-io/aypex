module Aypex
  class Menu < Aypex::Base
    ...
    has_many :menu_items, dependent: :destroy, class_name: "Aypex::MenuItem"
    belongs_to :store, touch: true, class_name: "Aypex::Store"
    ...
    has_one :root, -> { where(parent_id: nil) }, class_name: "Aypex::MenuItem", dependent: :destroy
