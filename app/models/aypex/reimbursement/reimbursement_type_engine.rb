module Aypex
  class Reimbursement::ReimbursementTypeEngine
    ...
    self.default_reimbursement_type = Aypex::ReimbursementType::OriginalPayment

    class_attribute :expired_reimbursement_type
    self.expired_reimbursement_type = Aypex::ReimbursementType::OriginalPayment

    class_attribute :exchange_reimbursement_type
    self.exchange_reimbursement_type = Aypex::ReimbursementType::Exchange
