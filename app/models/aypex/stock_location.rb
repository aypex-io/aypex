module Aypex
  class StockLocation < Aypex::Base
    ...
    belongs_to :state, class_name: "Aypex::State", optional: true
    belongs_to :country, class_name: "Aypex::Country"
    ...
    def create_stock_items
      Aypex::StockLocations::StockItems::CreateJob.perform_later(self)
    end
