module Aypex
  class Reimbursement < Aypex::Base
    ...
    with_options inverse_of: :reimbursement do
      has_many :refunds
      has_many :credits, class_name: "Aypex::Reimbursement::Credit"
    ...
    # reimbursements.
    # This allows a store to incorporate custom reimbursement methods that Aypex doesn't know about.
    ...
    def display_total
      Aypex::Money.new(total, currency: order.currency)
    end
