module Aypex
  class ProductProperty < Aypex::Base
    ...
    with_options inverse_of: :product_properties do
      belongs_to :product, touch: true, class_name: "Aypex::Product"
      belongs_to :property, touch: true, class_name: "Aypex::Property"
    end
    ...
    def property_name=(name)
      ActiveSupport::Deprecation.warn(<<-DEPRECATION, caller)
        `ProductProperty#property_name=` is deprecated and will be removed in Aypex 5.0.
      DEPRECATION
      if name.present?
