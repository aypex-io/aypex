module Aypex
  class StockItem < Aypex::Base
    ...
    scope :with_active_stock_location, -> { joins(:stock_location).merge(Aypex::StockLocation.active) }

    def backordered_inventory_units
      Aypex::InventoryUnit.backordered_for_stock_item(self)
    end
    ...
    def conditional_variant_touch
      ...
      variant.touch if !Aypex::Config.binary_inventory_cache || stock_changed
    end
  end
end
