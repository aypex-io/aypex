module Aypex
  class ReimbursementPerformer
    class << self
      ...
      self.reimbursement_type_engine = Aypex::Reimbursement::ReimbursementTypeEngine
      ...
      def execute(reimbursement, simulate)
        ...
        # {Aypex::ReimbursementType::OriginalPayment => [ReturnItem, ...], Aypex::ReimbursementType::Exchange => [ReturnItem, ...]}
