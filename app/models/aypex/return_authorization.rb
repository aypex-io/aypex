module Aypex
  class ReturnAuthorization < Aypex::Base
    ...
    belongs_to :reason, class_name: "Aypex::ReturnAuthorizationReason", foreign_key: :return_authorization_reason_id
    ...
    def currency
      ...
      order.nil? ? Aypex::Store.default.default_currency : order.currency
    end
    ...
    def generate_expedited_exchange_reimbursements
      return unless Aypex::Config.expedited_exchanges
