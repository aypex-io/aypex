module Aypex
  class InventoryUnit < Aypex::Base
    ...
    with_options inverse_of: :inventory_units do
      ...
      belongs_to :shipment, class_name: "Aypex::Shipment", touch: true, optional: true
      has_many :return_items, class_name: "Aypex::ReturnItem", inverse_of: :inventory_unit
      has_many :return_authorizations, class_name: "Aypex::ReturnAuthorization", through: :return_items
      belongs_to :line_item, class_name: "Aypex::LineItem"
    end

    belongs_to :original_return_item, class_name: "Aypex::ReturnItem"
    ...
    scope :backordered_per_variant, ->(stock_item) do
      includes(:shipment, :order)
        .where.not(aypex_shipments: {state: "canceled"})
        .where(variant_id: stock_item.variant_id)
        .where.not(aypex_orders: {completed_at: nil})
        .backordered.order("aypex_orders.completed_at ASC")
    end
    ...
    def current_or_new_return_item
      Aypex::ReturnItem.from_inventory_unit(self)
    end
