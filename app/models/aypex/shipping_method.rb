module Aypex
  class ShippingMethod < Aypex::Base
    acts_as_paranoid
    ...
    has_many :zones, through: :shipping_method_zones, class_name: "Aypex::Zone"

    belongs_to :tax_category, -> { with_deleted }, class_name: "Aypex::TaxCategory", optional: true
    ...
    def self.calculators
      aypex_calculators.send(model_name_without_aypex_namespace)
        .select { |c| c.to_s.constantize < Aypex::ShippingCalculator }
    end
