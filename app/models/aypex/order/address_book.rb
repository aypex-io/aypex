  ...
  class Order < Aypex::Base
    module AddressBook
      ...
      def bill_address_id=(id)
        address = Aypex::Address.find_by(id: id)
      ...
      def update_or_create_address(attributes = {})
        ...
        default_address_scope = user ? user.addresses : ::Aypex::Address
        ...
        ::Aypex::Address.find_or_create_by(attributes.except(:id, :updated_at, :created_at))
      end
    end
  end
end
