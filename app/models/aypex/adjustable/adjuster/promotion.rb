module Aypex
  module Adjustable
    module Adjuster
      class Promotion < Aypex::Adjustable::Adjuster::Base
        def update
        ...
        def best_promo_adjustment
          @best_promo_adjustment ||= adjustments.competing_promos.eligible.reorder("amount ASC, created_at DESC, id DESC").first
        end
