module Aypex
  module UserAddress
    ...
    included do
      belongs_to :bill_address, foreign_key: :bill_address_id, class_name: "Aypex::Address", optional: true
      alias_attribute :billing_address, :bill_address

      belongs_to :ship_address, foreign_key: :ship_address_id, class_name: "Aypex::Address", optional: true
      alias_attribute :shipping_address, :ship_address

      accepts_nested_attributes_for :ship_address, :bill_address

      has_many :addresses, -> { where(deleted_at: nil).order("updated_at DESC") }, class_name: "Aypex::Address", foreign_key: :user_id
