    ...
    module Google
      class Rss
        ...
        def store
          ...
          @store ||= Aypex::Store.find_by(id: @settings.store_id)
        end
        ...
        def optional_attributes
          Aypex::Dependencies.data_feeds_google_optional_attributes_service.constantize.new
        end

        def required_attributes
          Aypex::Dependencies.data_feeds_google_required_attributes_service.constantize.new
        end

        def optional_sub_attributes
          Aypex::Dependencies.data_feeds_google_optional_sub_attributes_service.constantize.new
        end

        def products_list
          Aypex::Dependencies.data_feeds_google_products_list.constantize.new
        end
      end
    end
  end
