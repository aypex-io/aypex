FactoryBot.define do
  factory :payment, class: Aypex::Payment do
    order
    amount { 45.75 }
    state { "checkout" }
    response_code { "12345" }
    ...
    factory :payment_with_refund do
      ...
      after :create do |payment|
        create(:refund, amount: 5, payment:)
      end
    end
  end

  factory :check_payment, class: Aypex::Payment do
    amount { 45.75 }
    order
  ...
  factory :store_credit_payment, class: Aypex::Payment, parent: :payment do
