FactoryBot.define do
  factory :stock_location, class: Aypex::StockLocation do
    ...
    country { |stock_location| Aypex::Country.first || stock_location.association(:country) }
    ...
    factory :stock_location_with_items do
      after(:create) do |stock_location, _evaluator|
        ...
        store = Aypex::Store.first || create(:store)
