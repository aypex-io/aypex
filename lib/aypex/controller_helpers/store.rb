module Aypex
  module ControllerHelpers
    module Store
      ...
      # https://github.com/aypex/aypex/pull/6295 and https://github.com/aypex/aypex/pull/6662).
      #
      # If your prices depend on something else, overwrite this method and add
      # more key/value pairs to the Hash it returns.
      #
      # Be careful though to also patch the following parts of Aypex accordingly:
      #
      # * `Aypex::VatPriceCalculation#gross_amount`
      # * `Aypex::LineItem#update_price`
      # * `Aypex::Stock::Estimator#taxation_options_for`
      ...
      def current_tax_zone
        @current_tax_zone ||= @current_order&.tax_zone || Aypex::Zone.default_tax
      end
