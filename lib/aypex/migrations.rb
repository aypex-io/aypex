module Aypex
  class Migrations
    ...
    # First split:
    #
    #   ["20131128203548", "update_name_fields_on_aypex_credit_cards.aypex.rb"]
    #
    # Second split should give the engine_name of the migration
    #
    #   ["update_name_fields_on_aypex_credit_cards", "aypex.rb"]
    #
    ...
    def match_engine?(engine)
      if engine_name == "aypex"
        # Avoid stores upgrading from 1.3 getting wrong warnings
        ["aypex.rb", "aypex_promo.rb"].include? engine
      else
