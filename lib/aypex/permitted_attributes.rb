module Aypex
  module PermittedAttributes
    ...
    @@product_attributes = [
      ...
      :cost_currency, :cost_price, :compared_price,
      {
        option_type_ids: [],
        category_ids: [],
        image_attributes: []
    ...
    @@user_attributes = [:email, :bill_address_id, :ship_address_id, :password, :first_name, :last_name,
      :password_confirmation, :selected_locale, {public_metadata: {}, private_metadata: {}}, :selected_locale]

    @@variant_attributes = [
      :name, :presentation, :cost_price, :discontinue_on, :lock_version,
      :position, :track_inventory,
      :product_id, :product, :option_values_attributes, :price, :compared_price,
