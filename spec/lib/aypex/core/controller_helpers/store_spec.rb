...
describe Aypex::ControllerHelpers::Store, type: :controller do
  ...
  describe "#current_price_options" do
    ...
    context "when there is a default tax zone" do
      ...
      before do
        allow(Aypex::Zone).to receive(:default_tax).and_return(default_zone)
      end
    ...
    context "when there is no default tax zone" do
      before do
        allow(Aypex::Zone).to receive(:default_tax).and_return(nil)
      end
