...
describe Aypex::Money do
  before do
    Aypex::Store.default.update(default_currency: "USD")
  end
  ...
  context "JPY" do
    before do
      Aypex::Store.default.update(default_currency: "JPY")
    end
  ...
  context "EUR" do
    before do
      Aypex::Store.default.update(default_currency: "EUR")
    end
