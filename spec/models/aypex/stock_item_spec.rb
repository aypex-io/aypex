...
describe Aypex::StockItem, type: :model do
  ...
  context "adjust count_on_hand" do
    ...
    it "is updated pessimistically" do
      copy = Aypex::StockItem.find(subject.id)
  ...
  describe "scopes" do
    describe ".with_active_stock_location" do
      let(:stock_items_with_active_location) { Aypex::StockItem.with_active_stock_location }
