...
describe Aypex::Cms::Sections::HeroImage, type: :model do
  ...
  context "when a new Hero Image section is created" do
    ...
    it "sets gutters to No Gutters" do
      section = Aypex::CmsSection.find(hero_section.id)
  ...
  context "when changing the link type" do
    ...
    before do
      hero_section.update!(linked_resource_type: "Aypex::Product")
    end
