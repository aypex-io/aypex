...
module Aypex
  describe Reimbursement::Credit, type: :model do
    ...
    describe "#description" do
      let(:credit) { Aypex::Reimbursement::Credit.new(amount: 100, creditable: create(:check_payment_method)) }
    ...
    describe "#display_amount" do
      let(:credit) { Aypex::Reimbursement::Credit.new(amount: 100) }

      it "is a money object" do
        expect(credit.display_amount).to eq Aypex::Money.new(100, currency: "USD")
      end
    end
  end
end
