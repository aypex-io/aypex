...
module Aypex
  describe Reimbursement::ReimbursementTypeEngine do
    describe "#calculate_reimbursement_types" do
      ...
      let(:reimbursement_type_engine) { Aypex::Reimbursement::ReimbursementTypeEngine.new(return_items) }
      let(:expired_reimbursement_type) { Aypex::ReimbursementType::OriginalPayment }
      let(:override_reimbursement_type) { Aypex::ReimbursementType::OriginalPayment.new }
      let(:preferred_reimbursement_type) { Aypex::ReimbursementType::OriginalPayment.new }
