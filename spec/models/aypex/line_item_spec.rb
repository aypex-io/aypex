...
describe Aypex::LineItem, type: :model do
  ...
  describe "#discontinued" do
    it "fetches discontinued products" do
      ...
      expect(line_item.reload.product).to be_a Aypex::Product
    end

    it "fetches discontinued variants" do
      line_item.variant.discontinue!
      expect(line_item.reload.variant).to be_a Aypex::Variant
    end
  end
  ...
  describe "#save" do
    context "line item changes" do
      ...
      it "triggers adjustment total recalculation" do
        expect(line_item).to receive(:update_tax_charge) # Regression test for https://github.com/aypex/aypex/issues/4671
    ...
    context "target_shipment is provided" do
      it "verifies inventory" do
        line_item.target_shipment = Aypex::Shipment.new
        expect_any_instance_of(Aypex::OrderInventory).to receive(:verify)
        line_item.save
      end
    end
  end
  ...
  describe "#money" do
    ...
    it "returns a Aypex::Money representing the total for this line item" do
