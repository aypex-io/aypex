...
describe "Order" do
  ...
  describe "#display_total_applicable_store_credit" do
    ...
    it "returns a money instance" do
      expect(subject.display_total_applicable_store_credit).to be_a(Aypex::Money)
    end
  ...
  describe "#display_total_applied_store_credit" do
    ...
    it "returns a money instance" do
      expect(subject.display_total_applied_store_credit).to be_a(Aypex::Money)
    end
  ...
  describe "#display_order_total_after_store_credit" do
    ...
    it "returns a money instance" do
      expect(subject.display_order_total_after_store_credit).to be_a(Aypex::Money)
    end
  ...
  describe "#display_total_available_store_credit" do
    ...
    it "returns a money instance" do
      expect(subject.display_total_available_store_credit).to be_a(Aypex::Money)
    end
  ...
  describe "#display_store_credit_remaining_after_capture" do
    ...
    it "returns a money instance" do
      expect(subject.display_store_credit_remaining_after_capture).to be_a(Aypex::Money)
    end
