...
RSpec.describe Aypex::Payment::GatewayOptions do
  ...
  let(:payment_method) do
    double(
      Aypex::Gateway::Bogus,
      exchange_multiplier: Aypex::Gateway::FROM_DOLLAR_TO_CENT_RATE
    )
  end
  ...
  let(:bill_address) do
    double Aypex::Address, active_merchant_hash: {bill: :address}
  end

  let(:ship_address) do
    double Aypex::Address, active_merchant_hash: {ship: :address}
  end
