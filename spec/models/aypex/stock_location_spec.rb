        ...
        context "propagate all variants" do
          ...
          context "true" do
            ...
            specify do
              ...
              expect(Aypex::StockLocations::StockItems::CreateJob).to(
    ...
    describe "#stock_item_or_create" do
      context "without stock item" do
        ...
        context "variant instance passed" do
          ...
          it { expect { subject.stock_item_or_create(variant) }.to change(Aypex::StockItem, :count) }
        end
        ...
        context "variant ID passed" do
          ...
          it { expect { subject.stock_item_or_create(variant.id) }.to change(Aypex::StockItem, :count) }
        end
      end
      ...
      context "with stock item" do
        ...
        context "variant instance passed" do
          it { expect { subject.stock_item_or_create(variant) }.not_to change(Aypex::StockItem, :count) }
          it { expect(subject.stock_item_or_create(variant)).to eq(stock_item) }
        end

        context "variant ID passed" do
          it { expect { subject.stock_item_or_create(variant.id) }.not_to change(Aypex::StockItem, :count) }
