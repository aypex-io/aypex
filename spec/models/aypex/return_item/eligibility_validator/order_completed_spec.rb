...
describe Aypex::ReturnItem::EligibilityValidator::OrderCompleted do
  ...
  describe "#eligible_for_return?" do
    ...
    context "the order is not completed" do
      ...
      it "sets an error" do
        subject
        expect(validator.errors[:order_not_completed]).to eq I18n.t("aypex.return_item_order_not_completed")
      end
    end
  end
end
