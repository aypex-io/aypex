...
RSpec.describe Aypex::WishedItem do
  describe ".quantity" do
    ...
    describe ".display_price" do
      it { expect(wished_item_with_variant.display_price(currency: "USD")).to eq Aypex::Money.new(variant.amount_in("USD"), currency: "USD") }
    end

    describe ".display_total" do
      it { expect(wished_item_with_variant.display_total(currency: "USD")).to eq Aypex::Money.new((variant.amount_in("USD") * 3), currency: "USD") }
    end
  end
end
