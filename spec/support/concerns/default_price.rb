shared_examples_for "default_price" do
  ...
  describe ".has_one :default_price" do
    ...
    it "has the class name of Aypex::Price" do
      expect(default_price_association.options[:class_name]).to eq "Aypex::Price"
    end
  end

  describe "#default_price" do
    it { expect(instance.default_price.class).to eql Aypex::Price }
